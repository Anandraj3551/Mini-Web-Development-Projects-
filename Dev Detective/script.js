...
function updateProfile(data) {
  ...
  if (data.message != "Not Found") {
    ...
    repos.herf = data?.repos_url;
    followers.innerText = data?.followers;
    followers.herf = data?.followers_url;
...
function enableDarkMode() {
  ...
  root.setProperty("--lm-bg-content", "#15292B");
...
// To check if User's device has a preference for dark mode or Not
